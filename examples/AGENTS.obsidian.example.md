...
`C:\Users\你的用户名\.codex\skills\update-changelog-obsidian\SKILL.md`
...
- The detailed changelog format, category rules, verification format, archive behavior, Obsidian Frontmatter, and Dataview usage are defined in the skill file.
